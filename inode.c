...
{
        pr_debug("ext2_iomap_begin is called.\n");	
...
{
        pr_debug("ext2_iomap_end is called.\n");	
...
{
        pr_debug("ext2_writepage is called.\n");	
	return block_write_full_page(page, ext2_get_block, wbc);
}

static int ext2_readpage(struct file *file, struct page *page)
{
    pr_debug("ext2_readpage is called.\n");	
...
{
    pr_debug("ext2_readpages is called.\n");		
...
{
        pr_debug("ext2_write_end is called.\n");	
	int ret;
...
ext2_nobh_write_begin(struct file *file, struct address_space *mapping,
		...
		struct page **pagep, void **fsdata)
{
        pr_debug("ext2_nobh_write_begin is called.\n");	
	int ret;
...
{
        pr_debug("ext2_nobh_writepage is called.\n");	
	return nobh_writepage(page, ext2_get_block, wbc);
}

static sector_t ext2_bmap(struct address_space *mapping, sector_t block)
{
        pr_debug("ext2_bmap is called.\n");	
...
{
        pr_debug("ext2_direct_IO is called.\n");	
